...
use App\Enums\EHobbyGroupActions;
...
class HobbyGroupController extends BaseController
{
	...
	{
		parent::__construct($latte, new EHobbyGroupActions());
	...
	{
		$id = $this->hobbyGroupFacade->saveHobbyGroup($variables);
		if ($id){
			$this->loadForm([BaseObjectEntity::BASE_ID => $id]);
		}
		bdump("Something fucked up");
	}
